    ...
    <>
      ...
      <main>
        <section className="p-5 flex flex-col gap-5 text-center">
          ...
          <p className="text-lg text-justify lg:text-center">En Allons-y somos estudiantes universitarios con infinitas ganas de darnos y ayudar a los demás y aportar un poquito de buen corazón allá donde vamos.</p>
        </section>
        <section>
          ...
          <article className="p-5 flex flex-col gap-5 text-lg justify-center items-center">
